...
class Agent():
	...
	def __init__(self, seller):
		...
		#produces a sell and a buy dictionary for the weights of the different predictions by random. The dictionaries are of the same length as the agent's memory
